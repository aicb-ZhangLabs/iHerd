...
def calculateGain(comObj, node, nodeNeighbors, nodeSelfWeight, nodeDegree, eDict, w, w_x2, weight='weight'):
    newEdges = [ eDict[(node,nei)] for nei in nodeNeighbors & set(comObj.nodeDict) - set([node]) ] # Include all neighbors to node in this community
    ...
    while True:
        ...
        for node in randomizeOrder(random, graph.nodes()):
            ...
            cost1,intraCommW1,allCommW1,comObj1NewMod = calculateCost(comObj1,
                                                        ...
                                                        pObj.tW_x2,
                                                        weight=weight)
            #neighborsToCalc = {the communities that has node's neighbors : those communities' information}
        ...
        print("Intial Mod : ", endLoopMod, "; Mod change : ", currentMod - endLoopMod)
